...
public class RenderUtils {
    ...
    public static void drawGradientRect(int par1, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        tessellator.addVertex((double)par3, (double)par2, (double)-90D);
        tessellator.addVertex((double)par1, (double)par2, (double)-90D);
        tessellator.setColorRGBA_F(f5, f6, f7, f4);
        tessellator.addVertex((double)par1, (double)par4, (double)-90D);
        tessellator.addVertex((double)par3, (double)par4, (double)-90D);
        tessellator.draw();
